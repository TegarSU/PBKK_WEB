            ...
            <h4><i class="fa fa-check-square">
                ...
                <div class="row">
                    ...
                    <div class="list-group">
                        ...
                        <a href="{{route('dosen.index')}}" class="list-group-item">
                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            {!!Form::model($m,['method'=>'PATCH','action'=>['dsnController@update',$m->id]]) !!}
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::text('nama', null, array('class' =>'form-control','placeholder'=>'Nama Dosen')) !!}
                            </div>
                            <div class="form-group">
                                {!! Form::label('alamat', 'Alamat Dosen') !!}
                                {!! Form::text('alamat', null, array('class' =>'form-control','placeholder'=>'Alamat Dosen')) !!}
                            </div>
